<form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20" wire:submit.prevent='crearVacante'>
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div class="flex gap-x-4 sm:col-span-2">
            <div class="flex h-6 items-center">
                ...
                <x-text-input id="imagen" wire:model="imagen" class="block mt-1" type="file" name="imagen" />
    ...
    <div class="mt-10">
        <button type="submit"
            class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Crear V</button>
    </div>
</form>